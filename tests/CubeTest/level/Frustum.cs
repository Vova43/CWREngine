...
namespace tests.CubeTest.level {
    ...
    public unsafe class Frustum {
        ...
        public Frustum() {
            ...
            m_Frustum[0] = new float[4];
            m_Frustum[1] = new float[4];
            m_Frustum[2] = new float[4];
            m_Frustum[3] = new float[4];
            m_Frustum[4] = new float[4];
            m_Frustum[5] = new float[4];
        ...
        private void normalizePlane(float[][] frustum, int side) {
            float magnitude = (float)System.Math.Sqrt(frustum[side][0] * frustum[side][0] +
        ...
        private void calculateFrustum() {
            fixed (float* params_ = &this.proj[0]) {
                Mem.memset(params_, 0, 16);
                GL11.glGetFloatv(GL11.GL_PROJECTION_MATRIX, params_);
            }
            fixed (float* params_ = &this.modl[0]) {
                Mem.memset(params_, 0, 16);
                GL11.glGetFloatv(GL11.GL_MODELVIEW_MATRIX, params_);
            }
